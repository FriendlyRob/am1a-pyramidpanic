...
namespace PyramidPanic
{
    ...
    {
        // Fields can de class helpscene
        private PyramidPanic game;

        // Contructor van de helpscene-class krijgt een object mee van het type PyramidPanic
        ...
        {
            this.game.GraphicsDevice.Clear(Color.Beige);
        }
    }
}
